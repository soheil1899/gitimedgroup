<aside class="pt-4">
    <div class="px-5 px-md-0 mx-auto col-8 col-md-12">
        <img class="mx-auto px-1 d-block logo-image" src="/media/Layout/{{$setting['logo']}}" width="80%">
    </div>
    ...
    <div dir="rtl" class="call-info d-none d-md-block px-2 pb-3">
        ...
        <div class="mx-3 mb-2 pr-5 pl-2">
            ...
            <label class="mr-5">{{$setting['phone']}}</label>
        </div>
        ...
        <div class="mx-3 mb-2 pr-5 pl-2">
            <label class="d-block"><strong>
                    ...
                    ایمیل :</strong></label>
            <label class="mr-5">{{$setting['email']}}</label>
        </div>
        ...
        @if($setting['fax'] != null)
            <div class="mx-3 mb-2 pr-5 pl-2">
                <label class="d-block"><strong>
                        ...
                        فکس :</strong></label>
                <label class="mr-5">{{$setting['fax']}}</label>
            </div>
        @endif
        ...
        <div class="mx-3 mb-2 pr-5 pl-2">
            <label class="d-block"><strong>
                    ...
                    آدرس :</strong></label>
            <label class="mr-5">{{$setting['address']}}</label>
        </div>
    </div>
